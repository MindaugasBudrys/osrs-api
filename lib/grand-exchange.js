...
const createItemDetailUrl = (itemId) => `localhost:3000/m=itemdb_oldschool/api/catalogue/detail.json?item=${itemId}`
const createItemGraphUrl = (itemId) => `localhost:3000/m=itemdb_oldschool/api/graph/${itemId}.json`

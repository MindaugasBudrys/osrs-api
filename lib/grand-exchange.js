...
const createItemDetailUrl = (itemId) => `http://crossorigin.me/http://services.runescape.com/m=itemdb_oldschool/api/catalogue/detail.json?item=${itemId}`
const createItemGraphUrl = (itemId) => `http://crossorigin.me/http://services.runescape.com/m=itemdb_oldschool/api/graph/${itemId}.json`
